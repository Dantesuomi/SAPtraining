...
public class DefaultExtensiontraining2Service implements Extensiontraining2Service
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultExtensiontraining2Service.class);
	...
	{
		return DefaultExtensiontraining2Service.class.getResourceAsStream("/extensiontraining2/sap-hybris-platform.png");
	}
