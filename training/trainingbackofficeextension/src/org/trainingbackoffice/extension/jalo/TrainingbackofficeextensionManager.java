 ...
 */
public class TrainingbackofficeextensionManager extends GeneratedTrainingbackofficeextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(TrainingbackofficeextensionManager.class.getName());
	 ...
	 */
	public static TrainingbackofficeextensionManager getInstance()
	{
		return (TrainingbackofficeextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(TrainingbackofficeextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public TrainingbackofficeextensionManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of TrainingbackofficeextensionManager called.");
		}
	}
